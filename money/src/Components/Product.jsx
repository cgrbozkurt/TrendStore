...
<div className="actions ">
  <button className='border-solid border-2 rounded-lg w-auto'>Sat</button>
  <span>{basketItem && basketItem.amount || 0}</span>
  <button  onClick={addBasket} className='border-solid border-2 rounded-lg w-auto'>Satın Al</button>
